...
public class App {
	...
	public static File arquivoFolhaPagamento = null;
	public static File arquivoValeAlimentacao = null;
	public static File arquivoValeTransporte = null;
	public static File arquivoValeCombustivel = null;
	public static File arquivoBoletoComprovanteVR = null;
	public static File arquivoVTOcr = null;
			...
			protected Void doInBackground() {
				try {
					...
					if (pastaPontosOri == null || pastaComprovantes == null || pastaContracheque == null
							|| arquivoFolhaPagamento == null || arquivoValeAlimentacao == null
							|| arquivoValeTransporte == null || arquivoValeCombustivel == null
							|| arquivoBoletoComprovanteVR == null) {
	...
	public static void selecionarArquivosEDiretorios() {
		...
		arquivoFolhaPagamento = selecionarArquivo("Selecione o ARQUIVO da FOLHA DE PAGAMENTO");
		arquivoValeAlimentacao = selecionarArquivo("Selecione o ARQUIVO da VALE ALIMENTAÇÃO");
		arquivoBoletoComprovanteVR = selecionarArquivo("Selecione o ARQUIVO do VR - BOLETO E COMPROVANTE");
		arquivoValeTransporte = selecionarArquivo("Selecione o ARQUIVO da VALE TRANSPORTE");
		arquivoValeCombustivel = selecionarArquivo("Selecione o ARQUIVO da VALE COMBUSTIVEL");
	}
	...
	public static File selecionarArquivo(String mensagem) {
		...
		chooser.setCurrentDirectory(
				new File("//adsj/files$/FINANCEIRO/2.FATURAMENTO/SUPORTE.TI/Documentação IFSUL 006.2021"));
